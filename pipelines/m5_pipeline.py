...
@dsl.component(base_image="python:3.10-slim", packages_to_install=BQ_PACKAGES)
...
@dsl.component(base_image="python:3.10-slim", packages_to_install=["google-cloud-storage==2.10.0"])
