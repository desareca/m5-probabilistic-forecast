...
output "artifact_registry_repo" {
  description = "URL del repo Docker para training containers (Fase 7)"
  value       = "${var.region}-docker.pkg.dev/${var.project_id}/${google_artifact_registry_repository.m5_training.repository_id}"
}
